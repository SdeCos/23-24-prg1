...
class ExamenAutomaticoPresonalizadoCorregido {
    public static void main(String[] args) {
        ...
        while (!(opcionMenu == SALIR)) {
            ...
            if (opcionMenu == CONFIGURACION) {
                ...
                do {
                    System.out.println("Elige el primer factor (2 <= x <= 10): ");
                ...
                test(primerFactor, dificultad, operacion);
    ...
    private static void test(int primerFactor, int dificultad, int operacion) {
        Scanner scanner = new Scanner(System.in);
